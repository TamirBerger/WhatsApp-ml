...
# Function to compute overall MAE across all data
def compute_overall_mae(df_list):
    all_errors = []
...
# Load and clean data
file_pattern = "/mnt/data/fpsLabels_*.csv"  # Update this to your file path
...
# Compute overall MAE
overall_mae = compute_overall_mae(df_list)
print(f"Overall MAE across all data: {overall_mae:.2f}")
